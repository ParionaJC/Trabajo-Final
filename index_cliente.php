    ...
    <div class="container mt-4">
        <section>
            <article align="center">
                <a href="pages/view/listarClientes.php" class="btn btn-outline-success mt-1"><i class="fa-solid fa-list"></i> Listar Cliente</a>
                <a href="pages/view/buscarClientes.php" class="btn btn-outline-success mt-1"><i class="fa-solid fa-magnifying-glass"></i> Consultar Cliente</a>                
                <!--<a href="pages/view/filtrarCategoria.php" class="btn btn-outline-success mt-1"><i class="fa-solid fa-filter"></i> Filtrar Cliente</a>-->
                <hr size="10">
            </article>
        </section>
        <br/>
