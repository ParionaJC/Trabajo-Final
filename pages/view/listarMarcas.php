...
<body>
    ...
    <nav>
        ...
        <a href="registrarMarca.php" class="btn btn-outline-success">
                    ...
                    <table class="table table-striped text-center">
                        ...
                        <tbody>
                            <?php
                                ...
                                foreach($marca->ListarMarcas() as $dato){
                                    $i++;
                            ?>
                                <tr>
                                    <td class="w-25"><?=$i ?></td>
                                    <td class="w-25"><?=$dato->codigo_marca ?></td>
                                    <td class="w-25"><?=$dato->marca ?></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
