...
<body>
    	...
    	<header>            
            ...
            <hr size="7" class="hr"> 
            <h1 class="texto"><i class="fa-solid fa-magnifying-glass"></i> Consultar Categorias</h1>
            </div> 
    	</header>
    	...
    	<section>
            ...
            <div class="row mt-2">
                <div class="col-md-6 col-lg-4 mx-auto mt-sm-2 mt-lg-0">
                    <form name="form-buscar-cate" id="form-buscar-cate" method="post">
                        <div class="mb-3">
                            <label for="txtCodigoC" class="form-label">Código de Categoria</label>
                            <input type="text" class="form-control shadow-none txtCodigoC" id="txtCodigoC" name="txtCodigoC" maxlength="5" autofocus>
                        </div>
                        <div class="mb-3">
                            <label for="txtCate" class="form-label">Categoria</label>
                            <input type="text" class="form-control shadow-none txtCate" id="txtCate" name="txtCate" readonly>
                        </div>
                        <div class="mb-3">
